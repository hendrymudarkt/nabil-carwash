				...
				<div class="box-body" id="div1">
					...
					<table class="table table-bordered table-striped">
						...
						<tbody>
							<?php
							$no = 1;
							$cetak = $this->db->query("SELECT * FROM pengeluaran WHERE DATE(tanggal) BETWEEN '$_POST[awal]' AND '$_POST[akhir]'")->result_array();
							foreach ($cetak as $c): ?>
							<tr>
								<td align="center"><?php echo $no++ ?></td>
								<td><?php echo $c['keterangan'] ?></td>
								<td><?php echo date('H:i:s d-m-Y', strtotime($c['tanggal'])); ?></td>
								<td align="right"><?php echo "Rp. ".number_format($c['biaya']) ?></td>
							</tr>
							<?php @$total += $c['biaya']; endforeach; ?>
							<tr>
